...
export default function PayerLoyerPage() {
  ...
  useEffect(() => {
    ...
    if (foundTenant) {
      ...
      if (foundTenant.statutMoisCourant === "paye") {
        ...
        setSelectedMethod(
          foundTenant.operateurPrefere === "wave" ||
            foundTenant.operateurPrefere === "orange_money"
            ? foundTenant.operateurPrefere
            : "wave",
        );
      }
    } else {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[300px]">
        ...
        <p className="text-xs text-slate-400 mt-2">
          Chargement du portail de paiement sécurisé...
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-md w-full mx-auto bg-white border border-slate-200 shadow-xl rounded-2xl p-6 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-slate-500 leading-relaxed">
            Ce lien de paiement unique a expiré ou est invalide. Veuillez
            contacter votre agence ou votre bailleur pour obtenir un nouveau
            lien de règlement.
          </p>
        </div>
  ...
  const isOverdue =
    tenant.statutMoisCourant === "en_retard" ||
    (tenant.statutMoisCourant === "partiel" && today > tenant.jourEcheance);
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Vous êtes invité à régler le loyer de votre logement :
              </p>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-150 p-4 rounded-xl space-y-3">
              ...
              <div className="border-t border-slate-200/60 pt-3 flex justify-between items-baseline">
                ...
                <span className="text-2xl font-black text-slate-800 tracking-tight">
                  {formatFCFA(
                    tenant.loyerMensuel - tenant.montantPayeMoisCourant,
                  )}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2.5 pt-2">
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">
                Sélectionnez un mode de règlement
              </span>
          ...
          <div className="p-8 text-center space-y-6 py-16 animate-pulse">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed max-w-xs mx-auto">
                Veuillez valider le paiement sur l'invite push USSD envoyée sur
                votre téléphone lié à{" "}
                <strong>{formatPhone(tenant.telephone)}</strong>.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="p-6 text-center space-y-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400">
                Merci, votre loyer est désormais à jour.
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-100 p-3 rounded-lg text-left text-[11px] text-blue-800 leading-normal flex gap-2">
              ...
              <p>
                Votre reçu de quittance de loyer a également été expédié par
            ...
            <button
              onClick={() =>
                toast.success("Reçu de quittance PDF téléchargé (Simulé).")
              }
            ...
            <div className="p-6 text-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-600 leading-normal">
                  Vous allez valider un paiement de{" "}
                  <strong>
                    {formatFCFA(
                      tenant.loyerMensuel - tenant.montantPayeMoisCourant,
                    )}
                ...
                <p className="text-[10px] text-slate-400">
                  Un push USSD ou un SMS interactif vous demandant de taper
                  votre code secret sera envoyé sur votre numéro{" "}
